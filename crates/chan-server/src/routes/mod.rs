...
pub use llm::{
    ...
    api_llm_complete, api_llm_gemini_models, api_llm_ollama_models, api_llm_resume,
    api_llm_set_anthropic_key, api_llm_set_gemini_key, api_llm_status, api_llm_tools,
};
pub use preferences::{
