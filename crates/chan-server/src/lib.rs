...
use routes::{
    ...
    api_read_file, api_report_dir, api_report_file, api_report_prefix, api_resolve_link,
    api_restart_terminal, api_search_content, api_search_files, api_set_terminal_submit_mode,
    api_set_terminal_watcher, api_storage_reset, api_team_list_loaded, api_team_load,
