...
use routes::{
    ...
    api_get_drive, api_get_server_config, api_get_session, api_graph, api_headings, api_health,
    api_index_rebuild, api_index_status, api_link_targets, api_links, api_list_assistant,
    api_list_files, api_list_sessions, api_llm_anthropic_models, api_llm_clear_anthropic_key,
    ...
    api_post_attachment, api_put_assistant, api_put_session, api_read_file, api_resolve_link,
