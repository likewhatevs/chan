...
### Startup
1. @@Architect reviews [](./summary.md).
...
4. @@Architect creates initial task files using the {agent-name}-{n}.md naming pattern.
5. Each agent reviews the task assigned to them, follows relative markdown links for context, and records progress in that task file.
