# phase-18-team - team bootstrap

Generated for the phase-18-team team. created_at: 2026-06-04T11:05:26.636487+00:00.
...
- @@Lead cuts a task into docs/journals/phase-18/team/tasks/task-{from}-{to}-{n}.md
...
- Keep a running log in docs/journals/phase-18/team/journals/journal-{your-name}.md
...
paper-trail under docs/journals/phase-18/team/followups/) and a Dismiss, so the host can pick
