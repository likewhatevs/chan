...
Current dialog:
_[screenshot removed: current Team Work / Spawn-agents dialog]_
New dialog:
...
_[screenshot removed: current Rich Prompt right-click menu]_
...
_[screenshot removed: target list-rendering style and glyph reference]_
- The common chords for editor bold Cmd+B and italic Cmd+I are missing. Let's add them.

### Hybrid hamburger
The current menu: _[screenshot removed: current Hybrid hamburger menu with split labels]_
