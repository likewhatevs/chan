...
- The highlight of an empty pane is thicker inside the pane than it is at the top bar; we want the thickness of the topbar all across, not the one from the body: ![](./image.png#w=250)
