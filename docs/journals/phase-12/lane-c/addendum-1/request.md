# Bugs
## Rich Prompt
- Launching the Rich Prompt's pre-flight works fine except that the agent that spawns in the Rich Prompt's terminal is only executed *after* the bootstrap... see the example here: ![](./image.png#w=250)
