...
- The terminal font completely broke after the screensaver and screen sleep: ![](./image.png#w=250)  and now ![](./image-1.png#w=250)
but then auto-recovered after a few seconds. Subsequent screensaver in/out did not affect the terminals anymore. They remain slightly glitchy: ![](./image-2.png#w=250)
