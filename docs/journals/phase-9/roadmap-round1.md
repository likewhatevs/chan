...
## Bugs
- Terminal fonts not rendering after switching tabs: ![](./image-8.png#w=250)
...
- Search (or something else?) making changes to the file I'm editing, without me asking: ![](./image.png#w=250)
- Bullet lists now indenting like '-' lists do: ![](./image-3.png#w=250) vs ![](./image-5.png#w=250)  
...
- Our terminal cannot render certain characteres, e.g. em dash: ![](./image-7.png#w=250)
...
### Frontend
- Hybrid's Hamburger
  - Changing from this: ![](./image-6.png#w=250)
  - To this:
    - New Draft  Cmd+N
    - Terminal  Cmd+T
    - File Browser  Cmd+O
