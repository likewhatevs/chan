...
## Other bugs
- While editing text and landing on a missing image, it is very hard to delete it - you have to figure out how to select the markdown text.. we need a 'delete' button in the preview, at least for missing files like this: ![](./image-15.png#w=250)
