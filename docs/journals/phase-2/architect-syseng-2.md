...
2026-05-16: re-scanned [[phase-2/journal.md]],
all `architect-*.md` handoffs, [[phase-2/webtest-2.md]],
...
- [[phase-2/frontend-10.md]] remains @@Frontend
  owned.
- [[phase-2/architect-webtest-2.md]] leaves the
  frontend-10 glyph probe / post-commit smoke with @@Webtest.
- [[phase-2/backend-5.md]] is BACKLOG and owned
