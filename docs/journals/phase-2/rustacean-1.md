...
state: [[phase-2/backend-1.md]],
[[phase-2/backend-2.md]],
[[phase-2/backend-3.md]] (mirrored by
[[phase-2/rustacean-2.md]]), and
[[phase-2/backend-4.md]] (mirrored by
...
- `indexed_file_exists(root, rel)` uses `symlink_metadata` (lstat),
  ...
  [[phase-1/summary.md]]. The `unwrap_or(false)`
...
- Wire shape matches what was frozen in
  [[phase-2/rustacean-3.md]] / `backend-4.md`.
