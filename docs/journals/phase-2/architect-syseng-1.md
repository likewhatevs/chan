...
[[phase-2/syseng-2.md]] is REVIEW. The full
...
2. Browser smoke for the live add/delete/rename graph paths is
   carried in [[phase-2/webtest-2.md]].

## Status

DONE. The depth-cap close-out I committed to in this ping landed
as [[phase-2/syseng-3.md]] (REVIEW). frontend-9's
...
[[phase-2/syseng-2.md]] (the four specialist
approvals from the first wave) and
[[phase-2/syseng-3.md]] (depth-cap close-out).
Both ready for ack.
