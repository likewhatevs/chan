...
phase-2 review pass in [[phase-2/rustacean-1.md]]
...
- [[phase-2/rustacean-1.md]] (source of the nits)
- [[phase-2/backend-2.md]] (search collapse)
- [[phase-2/backend-3.md]] (FS-truth)
- [[phase-2/backend-4.md]] (language graph)
- [[phase-2/backend-1.md]] (markdown tag gate; optional chan-core comment)
...
* 2026-05-16 recycled @@Rustacean boot: read
  ...
  [[phase-2/rustacean-3.md]], and this file.
  No [[phase-2/architect-rustacean-*.md]]
