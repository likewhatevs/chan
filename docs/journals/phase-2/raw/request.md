...
## Context
Everyone should review [[phase-1/summary.md]] before starting work, so we carry forward the lessons, unresolved follow-ups, and execution notes from phase 1.
...
* Own [[phase-2/journal.md]] and keep it current throughout the work.
...
* Produce [[phase-2/summary.md]] at the end of the phase.
...
## Process
All coordination for this phase should happen through markdown files in [[phase-2]]. Use @@mentions for assistant ownership and wiki links for related files so the graph stays useful.

### Startup
1. @@Architect reviews [[phase-1/summary.md]].
2. @@Architect creates or updates [[phase-2/journal.md]].
