...
[[phase-2/webtest-1.md]] and
[[phase-2/webtest-2.md]] with:
...
* What is **deferred to the next @@Webtest cycle**: the three
  remaining probes in [[phase-2/architect-9.md]]
...
the workaround from [[phase-2/architect-9.md]]
...
```
phase-2/webtest-1.md
phase-2/webtest-2.md
phase-2/webtest-smoke.mjs
phase-2/architect-webtest-1.md
```
...
* Any other `phase-2/*.md` files. Those are
...
Verification:
- node --check phase-2/webtest-smoke.mjs
- node phase-2/webtest-smoke.mjs
...
Append to [[phase-2/journal.md]] under the `## Log`
section:
...
- Recorded closing state in [[phase-2/webtest-1.md]] and
  [[phase-2/webtest-2.md]].
...
- Remaining uncommitted work is the architect phase bundle, including the
  frontend type-gap fixes noted in [[phase-2/webtest-2.md]].
- Ready for recycle.
