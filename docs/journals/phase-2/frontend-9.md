...
- [[phase-2/request.md]] Graph section item 1
  ...
  max-depth").
- [[phase-2/journal.md]] decision 6 (cap source
...
* @@Webtest extends the CDP smoke (see
  [[phase-2/webtest-2.md]]) to verify the
...
* @@Webtest browser smoke:
  * [[phase-2/webtest-smoke.mjs]] now verifies depth caps for
