...
Relevant links: [[chan-pre-release-phase-2/request.md]], [[chan-pre-release-phase-1/summary.md]]
...
- Files changed: `web/src/components/SearchPanel.svelte`, `chan-pre-release-phase-2/frontend-1.md`.
