...
Relevant links: [[chan-pre-release-phase-2/request.md]]
...
- Files changed: `web/src/editor/decorations/blocks.ts`, `web/src/editor/decorations/blocks.test.ts`, `web/src/editor/Wysiwyg.svelte`, `chan-pre-release-phase-2/frontend-5.md`.
