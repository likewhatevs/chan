...
Relevant links: [[chan-pre-release-phase-2/request.md]], [[chan-pre-release-phase-2/journal.md]]
...
- Files changed: `web/src/components/GraphCanvas.svelte`, `chan-pre-release-phase-2/frontend-6.md`.
