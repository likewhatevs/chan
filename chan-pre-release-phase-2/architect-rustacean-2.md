...
- No [[chan-pre-release-phase-2/architect-rustacean-*.md]] inbound
  was present at boot.
- [[chan-pre-release-phase-2/rustacean-1.md]] remains the
  authoritative closed Rust review: backend-1..4 plus
  rustacean-2/3 mirrors APPROVED for commit.
- Last-known full Rust gate from [[chan-pre-release-phase-2/rustacean-1.md]]:
...
- [[chan-pre-release-phase-2/rustacean-4.md]] is still TODO and
