...
Source request: [[chan-pre-release-phase-2/request.md]].
Carry-forward context: [[chan-pre-release-phase-1/summary.md]].
...
These rules came out of [[chan-pre-release-phase-1/summary.md]] and
...
* [REVIEW] G3: depth slider clamps to a scope-aware maximum
  ...
  Owner: @@Frontend ([[chan-pre-release-phase-2/frontend-9.md]]).
...
* [REVIEW] S4: clicking a search row whose hit is a heading shows
  ...
  (covered by [[chan-pre-release-phase-2/frontend-1.md]] +
  [[chan-pre-release-phase-2/frontend-3.md]]).
...
* [REVIEW] L2: graph overlay gains a Language filter chip and a
  ...
  ([[chan-pre-release-phase-2/frontend-8.md]]). webtest-2 confirmed
...
* [DONE] H1: syseng hardening pass on `/api/graph` FS-truth, the
  ...
  [[chan-pre-release-phase-2/syseng-3.md]]). All four surfaces
...
* [DONE] R1: @@Rustacean Rust review pass on phase-2 backend work.
  Owner: @@Rustacean
  ([[chan-pre-release-phase-2/rustacean-1.md]]). backend-1..4 +
...
* [REVIEW] T1: webtest smoke extension. Owner: @@Webtest
  ([[chan-pre-release-phase-2/webtest-2.md]]). Search overlay
  ...
  [[chan-pre-release-phase-2/architect-8.md]] and
  [[chan-pre-release-phase-2/architect-9.md]].
* [BACKLOG] F1: chan-report reconcile-on-load + bulk-create gap.
  Non-blocking phase-2 follow-up. Owner: @@Backend
  ([[chan-pre-release-phase-2/backend-5.md]]).
...
[[chan-pre-release-phase-2/syseng-1.md]] is the syseng pre-architect
...
* 2026-05-16 @@Architect: read [[chan-pre-release-phase-1/summary.md]]
  and [[chan-pre-release-phase-2/request.md]]. Audited the current
...
* 2026-05-16 @@Backend: reconciled language graph work into
  [[chan-pre-release-phase-2/backend-4.md]]. Canonical endpoint is
  `GET /api/graph/languages?depth=<n>&language=<name>` and
  `cargo test -p chan-server` passed with 99 tests.
* 2026-05-16 @@Backend: filed
  [[chan-pre-release-phase-2/backend-5.md]] as the non-blocking
  chan-report reconcile follow-up from [[chan-pre-release-phase-2/architect-8.md]].
...
* 2026-05-16 @@Architect: kickoff dispatch closed. Reconciled the
  ...
  [[chan-pre-release-phase-2/frontend-9.md]] for the scope-aware
  depth cap (G1) and [[chan-pre-release-phase-2/webtest-2.md]] for
  the smoke coverage matrix; [[chan-pre-release-phase-2/syseng-2.md]]
...
* 2026-05-16 @@Architect: second sweep. frontend-9 landed in REVIEW
  ...
  [[chan-pre-release-phase-2/architect-8.md]]: workaround is
  `rm /tmp/chan-dev/.chan/report.jsonl` + restart, real fix filed
  as non-blocking [[chan-pre-release-phase-2/backend-5.md]].
  ...
  specialist reviews inside [[chan-pre-release-phase-2/syseng-2.md]]
  ...
  stays HELD.
* 2026-05-16 @@Syseng: [[chan-pre-release-phase-2/syseng-2.md]] REVIEW.
...
* 2026-05-16 @@Rustacean: [[chan-pre-release-phase-2/rustacean-1.md]] DONE.
...
* 2026-05-16 @@Syseng: [[chan-pre-release-phase-2/syseng-3.md]] REVIEW.
  ...
  blockers. Closing [[chan-pre-release-phase-2/architect-syseng-1.md]]
  as DONE.
* 2026-05-16 @@Architect: third sweep. Acked rustacean-1, syseng-2,
  ...
  [[chan-pre-release-phase-2/architect-8.md]]. Filed an explicit
  @@Webtest handoff in [[chan-pre-release-phase-2/architect-9.md]]
  ...
  as [[chan-pre-release-phase-2/frontend-10.md]] (F2 follow-up) so
  it can ride along on the phase commit if it lands in time.
* 2026-05-16 @@Rustacean: filed
  [[chan-pre-release-phase-2/rustacean-4.md]] as a ride-along
...
* 2026-05-16 @@Webtest B: picked up phase-2 webtest lane in
  ...
  [[chan-pre-release-phase-2/webtest-smoke.mjs]] — a luminance
  ...
  [[chan-pre-release-phase-2/webtest-2.md]] "@@Webtest B
...
* 2026-05-16 @@Architect: fourth sweep + commit plan freeze.
  ...
  - rustacean-4 OPTION A approved. Routed to @@Rustacean via
    [[chan-pre-release-phase-2/architect-rustacean-3.md]]. Polish
  ...
  4. **chan** commit 3/3:
     ...
     content: every `chan-pre-release-phase-2/*.md` task file
     not already in commit 6f33351, plus webtest-1/2.md note
     updates, plus the phase summary
     `chan-pre-release-phase-2/summary.md` (authored at commit
     time).
  ...
  - Architect writes `chan-pre-release-phase-2/summary.md` as
    part of commit 4.
* 2026-05-16 @@Webtest B: frontend-10 runtime-verify complete.
  ...
  Details + tear-down in [[chan-pre-release-phase-2/webtest-2.md]]
