...
Relevant links: [[chan-pre-release-phase-2/journal.md]], [[chan-pre-release-phase-2/rustacean-2.md]], [[chan-pre-release-phase-2/request.md]]
...
- Files changed: `web/src/state/store.svelte.ts`, `web/src/components/GraphPanel.svelte`, `web/src/state/store.test.ts`, `chan-pre-release-phase-2/frontend-7.md`.
