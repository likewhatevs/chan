...
Relevant links: [[chan-pre-release-phase-2/journal.md]], [[chan-pre-release-phase-2/rustacean-3.md]], [[chan-pre-release-phase-2/backend-4.md]], [[chan-pre-release-phase-2/request.md]]
...
- Backend registered `GET /api/graph/languages` and documented the frozen wire shape in [[chan-pre-release-phase-2/rustacean-3.md]] and [[chan-pre-release-phase-2/backend-4.md]].
...
- Files changed: `web/src/api/types.ts`, `web/src/api/client.ts`, `web/src/state/store.svelte.ts`, `web/src/components/SearchStatusOverlay.svelte`, `web/src/components/GraphPanel.svelte`, `web/src/components/GraphCanvas.svelte`, `chan-pre-release-phase-2/frontend-8.md`.
...
- Browser smoke: [[chan-pre-release-phase-2/webtest-smoke.mjs]] passed against
...
- Known risks: shared-drive language coverage is currently Markdown-only until
  the code-report/source-copy finding in [[chan-pre-release-phase-2/webtest-2.md]]
  is resolved.
