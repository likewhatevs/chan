...
| [dump-skill](v0.72.0/dump-skill.md) | implemented on `feat/dump-skill` (`81aca589`) | close the review findings in the item's Known Gaps, then merge; touches `CHANGELOG.md` only |
