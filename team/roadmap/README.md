...
| [distributed-proxy-control-plane-hardening](v0.74.0/distributed-proxy-control-plane-hardening.md) | **proposal, NOT yet accepted scope**; an adversarial security review of the control plane design, carrying one critical and several high findings against the branch | the owner accepts, amends or rejects it; if accepted, its amendments fold into the control plane item before steps 5 to 9 continue |
