...
- [release-v0.72.1](release-v0.72.1.md) - the AUR publication patch: the post-install unit verification runs with the privileges it needs, and the chan-desktop RPM refuses EL9 with a clear reason.
