...
<HybridSurfaceConfigShell
  ...
  {onDone}
>
  <!-- Appearance: device-wide chrome + editor body theme. Lives
       in browser storage; "System" follows the OS setting live.
       Per-Hybrid Inherit / Light / Dark overrides live in
...
<style>
  ...
  /* Appearance chip row, in sync with HybridEditorConfig +
