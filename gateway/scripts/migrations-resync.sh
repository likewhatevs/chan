...
#
# Usage:
#   scripts/migrations-resync.sh                  # uses $DATABASE_URL
#   scripts/migrations-resync.sh <database-url>   # explicit URL
#   scripts/migrations-resync.sh --dry-run        # show diffs only
#   scripts/migrations-resync.sh --yes            # skip the prompt
#
