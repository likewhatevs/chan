...
- `domain`: public hostnames (`id.<base>`, `devserver.<base>`, `.devserver.<base>`) derived from `CHAN_DOMAIN`; identity and devserver-proxy use it so the devserver-gate `aud` cannot drift.
