...
v0.67.0 makes co-viewed windows converge live, gives every session participant a name, and narrates gateway devserver sign-in and connect failures in the launcher.
